...
const TextTheme TEXT_THEME_DEFAULT = TextTheme(
    ...
    headline5: TextStyle(fontSize: 18.0, color: Color(0xff405061),height: 1.3, ),
    headline6: TextStyle(fontSize: 14.0, color: Color(0xff0D47A1), height: 1.5, fontWeight: FontWeight.w800, decoration: TextDecoration.underline),
