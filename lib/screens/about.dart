                ...
                Expanded(
                  child: Container(
                      padding: EdgeInsets.only(
                          left: 20.0, top: 14.0, right: 20.0, bottom: 30.0),
                      child: Center(
                          child: InkWell(
                        child: RichText(
                          text: TextSpan(
                              ...
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                  text: ' the regions primary health provider.',
                                  style: Theme.of(context).textTheme.bodyText1,
                                )
                              ]),
                        ),
                        ...
                        child: Center(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'To provide high quality healthcare in collaboration with our communities and partners, enhanced through education and research.',
                                style: TextStyle(
                                  fontFamily: 'Meta',
                                  fontSize: 14.0,
                                ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Image(
                                    image:
                                        AssetImage('assets/images/values.jpg')),
                              )
                            ],
                          ),
                        ))),
